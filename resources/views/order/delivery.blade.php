...
<div class="p-6 ml-12 md:p-8 md:ml-0">
    <!-- Header Section -->
   <div class="mb-8">
            <h1 class="text-6xl md:text-4xl font-bold text-gray-900 text-center animate-fade-in">Orders Delivery</h1>
        </div>
            ...
            <table class="w-full text-sm">
                ...
                <tbody id="platTipisTable">
                    @forelse($orders['plat-tipis'] ?? [] as $order)
                        @if($order->status === 'complete' && !is_null($order->delivery_at))
                    ...
                    @empty
                        <tr>
                            <td colspan="3" class="px-4 py-8 text-center text-gray-500">No delivered orders yet</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
